const SUBJECT_RULES = [
  ...
  ['História do Brasil', ['brasil colônia', 'império do brasil', 'república velha', 'era vargas', 'estado novo', 'getúlio', 'dom pedro', 'abolição', 'escravidão no brasil', 'constituição de 1934', 'constituição de 1937', 'constituição de 1967', 'golpe de 1964', 'regime militar', 'regime civil-militar', 'lei da anistia', 'rio branco', 'tratado de petrópolis']],
  ['História Mundial', ['absolutismo', 'mercantilismo', 'revolução inglesa', 'revoluções inglesas', 'revolução gloriosa', 'revolução francesa', 'revolução russa', 'revolução industrial', 'primeira guerra mundial', 'segunda guerra mundial', 'guerra fria', 'antigo regime', 'imperialismo', 'colonialismo', 'união soviética', 'nazismo', 'fascismo', 'iluminismo']],
  ...
  ['Geografia', ['território', 'urbanização', 'rede urbana', 'migração', 'demografia', 'geopolítica', 'geografia política', 'friedrich ratzel', 'crescimento espacial dos estados', 'estado como organismo vivo', 'meio ambiente', 'bioma', 'clima', 'cartografia', 'agricultura', 'industrialização', 'globalização', 'amazônia']],
];
...
const TOPIC_RULES = {
  ...
  'História do Brasil': [
    ...
    ['República de 1946 e regime militar', ['constituição de 1967', 'golpe de 1964', 'regime militar', 'regime civil-militar', 'lei da anistia', 'ditadura', 'anos 1970']],
  ],
  'História Mundial': [
    ['Absolutismo, mercantilismo e Revoluções Inglesas', ['absolutismo', 'mercantilismo', 'revolução inglesa', 'revoluções inglesas', 'revolução gloriosa']],
  ...
  Geografia: [
    ...
    ['Geopolítica', ['geopolítica', 'geografia política', 'friedrich ratzel', 'crescimento espacial dos estados', 'estado como organismo vivo', 'território']],
  ],
};
